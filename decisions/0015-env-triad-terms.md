...
> **DEPRECATED**: This ADR has been superseded by [ADR-0015: NMDC Environmental Triad Value Sets](0015-env-triad-value-sets.md), which consolidates this document and `0015-env-triad-structure.md` into a single accepted decision record.
